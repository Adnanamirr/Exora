        ...
        <div class="nk-sidebar-brand">
            <a href="" class="logo-link">
                <div class="logo-wrap">
                    ...
                    <img class="logo-img logo-icon" src="{{asset('backend/images/logo-icon.png')}}" srcset="{{asset('backend/images/logo-icon2x.png 2')}}x" alt="">
                </div>
            </a>
            ...
            <div class="border border-light rounded-3">
                <div class="px-3 py-2 bg-white border-bottom border-light rounded-top-3">
                    <div class="d-flex flex-wrap align-items-center justify-content-between">
                        ...
                        <a class="link link-primary" href="{{asset('backend/pricing-plans.html')}}">
